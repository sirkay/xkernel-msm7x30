...
#define CONFIG_ZRAM_DEFAULT_DISKSIZE 80000000
...
#define CONFIG_MD 1
#define CONFIG_LOCALVERSION "$(KERNEL_LOCAL_VERSION)-xKernel"
...
#define CONFIG_ZRAM_DEFAULT_PERCENTAGE 20
#define CONFIG_LLC 1
